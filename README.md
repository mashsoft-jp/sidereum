...
- 土星の情報パネルの「環を探る」から、環の局所的な氷粒子を間近で眺める試作表示へ切り替えられる。ドラッグで見回し、移動の停止・画像保存・元の視点への復帰に対応。粒子は不規則な立体で、形・大きさ・間隔を強調した鑑賞用の模式表現（個体形状の実測復元や衝突計算ではない）。組成の参考: [NASA Cassini — Rings](https://science.nasa.gov/mission/cassini/science/rings/)
