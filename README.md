...
- 食 (日食・月食) は上記の惑星・月の位置から幾何を解いて描いています。起きる・起きないは正しく出ますが、**時刻は実際より数分〜30分ほどずれます** (月食は 2〜3分、日食は観測地の視差が効くぶん大きく、2035-09-02 の東京での皆既で約18分、2030-06-01 の札幌での金環で約29分遅い)。食の予報には使えません
