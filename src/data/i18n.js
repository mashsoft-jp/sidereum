  ...
  const UI = {
    ja: {
      ...
      menuTerrainOn: "風景を表示",
      menuTerrainOff: "風景を隠す",
      menuBloomOn: "光の滲みを入れる",
      menuBloomOff: "光の滲みを切る",
      menuHiResOn: "高解像度テクスチャ",
      menuHiResOff: "標準解像度テクスチャ",
    ...
    en: {
      ...
      menuTerrainOn: "Show scenery",
      menuTerrainOff: "Hide scenery",
      menuBloomOn: "Enable glow",
      menuBloomOff: "Disable glow",
      menuHiResOn: "High-res textures",
      menuHiResOff: "Standard-res textures",
