  ...
  const UI = {
    ja: {
      ...
      arDenied: "端末の向きを使う許可が得られなかったので、AR を始められませんでした (Safari は一度断ると、読み込み直すまで聞き直しません)",
      arStartBtn: "タップして AR を開始",
      arStartNote: "端末の向きを使う許可を求めます",
      ...
      cal: {
        title: "天文カレンダー",
        lead: (site) => "観測地「" + site + "」から見える、この年のできごと。" +
                        "日食・月食は、この観測地で見えるものだけを載せています。済んだものは暗くしてあります。",
        note: "※「見る」は、そのできごとの前後でいちばん見やすい時刻へ移動します。位置計算が近似なので、日時は実際より数分〜20分ほどずれます (予報には使えません)",
        go: "見る",
        none: "この年に該当するできごとはありません",
        next: "次の年", prev: "前の年", yearSel: "年を選ぶ", thisYear: "今年",
        fullmoon: "満月",
        ...
        shower: (n) => n + "が極大",
        magSuffix: (m) => "最大食分 " + m,
        bigMoon: (km) => "今年いちばん大きな満月 (" + km + "万km)",
        smallMoon: (km) => "今年いちばん小さな満月 (" + km + "万km)",
        season: ["春分", "夏至", "秋分", "冬至"],
        seasonSub: ["太陽が天の赤道を南から北へ横切る日。昼と夜がほぼ同じ長さ",
                    "太陽がいちばん北に寄る日。北半球では昼がいちばん長い",
                    "太陽が天の赤道を北から南へ横切る日。昼と夜がほぼ同じ長さ",
                    "太陽がいちばん南に寄る日。北半球では昼がいちばん短い"],
        perihelionE: (km) => "地球が近日点 (太陽まで " + km + "万km)",
        aphelionE: (km) => "地球が遠日点 (太陽まで " + km + "万km)",
        apsisSub: "太陽の見かけの大きさが一年でいちばん変わるところ。差は 3% ほど",
        perihelion: (n, au) => n + "が近日点を通過 (太陽まで " + au + " au)",
        perihelionSub: "太陽にいちばん近づき、コマと尾がもっとも発達する頃",
        closest: (n, au) => n + "が地球に最接近 (" + au + " au)",
        closestSub: "地球からいちばん大きく明るく見える頃",
        retroStart: (n) => n + "が逆行をはじめる (留)",
        retroEnd: (n) => n + "が逆行を終える (留)",
        retroStartSub: "星々のあいだを西向きに動きはじめます。衝が近い印",
      ...
      searchToGround: "地上ビューに切り替えました", searchBelow: "いまは地平線の下です",
    ...
    en: {
      ...
      arDenied: "Permission to use the device orientation was not granted, so AR could not start (Safari does not ask again until the page is reloaded)",
      arStartBtn: "Tap to start AR",
      arStartNote: "Asks for permission to use the device orientation",
      ...
      cal: {
        title: "Sky calendar",
        lead: (site) => "What happens this year as seen from " + site + ". " +
                        "Eclipses are listed only when they are visible from this site. Past events are dimmed.",
        ...
        next: "Next year", prev: "Previous year", yearSel: "Choose a year", thisYear: "This year",
        fullmoon: "Full moon",
        ...
        bigMoon: (km) => "Largest full moon of the year (" + km + " km)",
        smallMoon: (km) => "Smallest full moon of the year (" + km + " km)",
        season: ["March equinox", "June solstice", "September equinox", "December solstice"],
        seasonSub: ["The Sun crosses the celestial equator heading north. Day and night are about equal",
                    "The Sun reaches its northernmost point. Longest day in the northern hemisphere",
                    "The Sun crosses the celestial equator heading south. Day and night are about equal",
                    "The Sun reaches its southernmost point. Shortest day in the northern hemisphere"],
        perihelionE: (km) => "Earth at perihelion (" + km + " million km from the Sun)",
        aphelionE: (km) => "Earth at aphelion (" + km + " million km from the Sun)",
        apsisSub: "The Sun's apparent size is at its yearly extreme. The difference is about 3%",
        perihelion: (n, au) => n + " at perihelion (" + au + " au from the Sun)",
        perihelionSub: "Closest to the Sun, when the coma and tail are at their fullest",
        closest: (n, au) => n + " closest to Earth (" + au + " au)",
        closestSub: "Biggest and brightest as seen from Earth",
        retroStart: (n) => n + " begins retrograde motion",
        retroEnd: (n) => n + " ends retrograde motion",
        retroStartSub: "Starts drifting westward against the stars. Opposition is near",
      ...
      searchToGround: "Switched to the ground view", searchBelow: "Below the horizon right now",
