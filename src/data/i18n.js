  ...
  const UI = {
    ja: {
      ...
      viewSpace: "宇宙", viewGround: "地上", viewMoon: "月面", viewAR: "AR", gFovLabel: "ズーム", gAzLabel: "方位", gAltLabel: "高度",
      hint: "ドラッグで回転 ・ 右ドラッグ / 2本指で移動 ・ ホイール / ピンチでズーム (Shift+で距離) ・ 天体クリックで接近",
      hintGround: "ドラッグで見回す ・ ホイール / ピンチでズーム ・ 天体タップで選択・追尾",
      hintAR: "端末を空へ向ける ・ 星を実際の位置へドラッグして方位を補正 ・ ピンチでズーム",
      hintARRel: "この端末は方位を取れません ・ 星を実際の位置へドラッグして合わせてください",
      arDenied: "端末の向きを使う許可が得られなかったので、AR を始められませんでした",
      arNoSensor: "この端末では向きのセンサーが使えないため、AR を始められませんでした",
      arCal: (d) => "方位補正 " + d + "  ✕",
    ...
    en: {
      ...
      viewSpace: "Space", viewGround: "Ground", viewMoon: "Moon", viewAR: "AR", gFovLabel: "Zoom", gAzLabel: "Azimuth", gAltLabel: "Alt",
      ...
      hintAR: "Point the device at the sky · Drag a star onto its real position to correct the heading · Pinch to zoom",
      hintARRel: "This device has no compass · Drag a star onto its real position to align",
      arDenied: "Permission to use the device orientation was not granted, so AR could not start",
      arNoSensor: "No orientation sensor is available on this device, so AR could not start",
      arCal: (d) => "Heading " + d + "  ✕",
