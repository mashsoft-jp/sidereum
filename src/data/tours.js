  ...
  const TOURS = [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          text: {
            ja: "ここからは下のパネルを使います。拡大・縮小は {mag} の行で、" +
                "スライダーを動かすか − ＋ を押してください。" +
                "マウスホイールでも同じことができます。",
            en: "From here we use the panel below. Zoom with the {mag} row — drag the " +
                "slider, or use − and +. The mouse wheel does the same thing.",
          },
        },
        {
          scene: false, await: "dist", ui: ["controls"], hi: "#zoom",
          text: {
            ja: "{dist} の行では、拡大率ではなく太陽系との距離そのものが変わります。" +
                "動かすと {mag} の行は ×1.0 のまま、{dist} の数字だけが変わります。" +
                "Shift を押しながらホイールでも同じです。",
            en: "The {dist} row changes your distance from the Solar System itself, rather " +
                "than the magnification: move it and the {mag} row stays at ×1.0 while only " +
                "the {dist} number changes. Shift+wheel does the same thing.",
          },
        },
        {
          ...
          text: {
            ...
            en: "Right-drag to slide the view sideways. This one has no panel equivalent — " +
                "handy for following something that has drifted off centre.",
          },
        },
        {
      ...
      steps: [
        ...
        },
        {
          ...
          text: {
            ...
            en: "From here we use the panel below. Zoom with the {mag} row — drag the " +
                "slider, or tap − and +. Pinching with two fingers does the same thing.",
          },
        },
        {
          scene: false, await: "dist", ui: ["controls"], hi: "#zoom",
          text: {
            ...
            en: "The {dist} row changes your distance from the Solar System itself, rather " +
                "than the magnification: move it and the {mag} row stays at ×1.0 while only " +
                "the {dist} number changes. Try it.",
          },
        },
        {
          scene: false, await: "pan", ui: [], hi: null,
          text: {
            ja: "2本の指を同時にドラッグすると、見ている位置を平行に動かせます。" +
                "これはパネルに無い、画面だけの操作です。" +
                "中心から外れた天体を追いたいときに使います。",
            en: "Drag with two fingers to slide the view sideways. This one has no panel " +
                "equivalent — handy for following something that has drifted off centre.",
          },
        },
        {
          scene: false, await: "angle", ui: ["controls"], hi: "#camSelect, #angleCell",
