  ...
  //   trail { key, dates: [UTC ISO], labels: [表示名] }。地上ビューで、その天体が各日時に
  //         いた空の位置を印で置き、順に矢印でつなぐ (逆行のループを見せる)。
  //         方向は恒星と同じ固定扱いなので、向きを同じ恒星時に揃えた回で使う
  ...
  //         進み具合はナレーションの上端の帯に出て、止まったら「ここまで」の
  //         合図が付く (どこで 次へ を押せばいいのかを分かるようにするため)。
  ...
  //   cut   カメラを緩和させず、その場に置く (カット割り)。同じ構図で日時だけ
  //         違う回が続くところで使う — 行きつ戻りつのたびに寄り引きが大きく
  //         振られると酔うため
  ...
  // (通常操作と同じ動きで繋がる)。cut を書いた回だけ、その場で置く。
  //
  // 終了時は開始前の状態 (日時・ビュー・カメラ・速度・選択) へ戻す。
  // 終わった場面にそのまま留まらせたいツアーだけ、ツアー側に keep: true を書く。
  // 新しいツアーは、指示がないかぎりこの配列の末尾に足す (一覧の並び順になる)。
  // 探査機の航路を見せる回は、比較に必要な惑星と冥王星の軌道だけに絞る。
  const TOUR_PLANET_ORBITS = ["mercury", "venus", "earth", "mars", "jupiter", "saturn", "uranus", "neptune", "pluto"];
  const TOURS = [
    {
      id: "basics-desktop",
      platform: "desktop",
        ...
        },
        {
          ...
          text: {
            ...
            en: "The small label right of the time (JST, GMT+1, …) says which clock you are " +
                ...
                "and the calendar follow along. Give it a click.",
          },
        },
        {
        ...
        },
        {
          ...
          text: {
            ja: "時刻の右の小さな文字 (JST など) は、どこの時刻で読むかを表します。" +
                ...
                "出没やカレンダーも一緒に変わります。タップしてみてください。",
            en: "The small label right of the time (JST, GMT+1, …) says which clock you are " +
                "reading. Tap it to cycle device → observing site → UTC; rise/set times " +
                "and the calendar follow along. Give it a tap.",
          },
        },
        {
          scene: false, ui: ["controls"], hi: "#play, #speed", await: "play",
    ...
    },
    {
      ...
      steps: [
        ...
        {
          sel: null, fit: 6.6, a: 0.5, y: 0.9, spot: "voyager1", front: null, path: true, orbits: TOUR_PLANET_ORBITS,
        ...
        },
        {
          ...
          sel: null, ride: null, fit: 12, a: 0.5, y: 0.9, mag: 1, orbits: TOUR_PLANET_ORBITS, path: true,
    ...
    },
    {
      ...
      steps: [
        ...
        {
          sel: null, fit: 6.6, a: 0.5, y: 0.9, spot: "voyager2", front: null, path: true, orbits: TOUR_PLANET_ORBITS,
        ...
        {
          sel: null, ride: null, fit: 24, a: 0.5, y: 0.9, mag: 1, orbits: TOUR_PLANET_ORBITS, path: true,
        ...
        {
          sel: null, ride: null, fit: 38, a: 0.5, y: 0.9, mag: 1, orbits: TOUR_PLANET_ORBITS, path: true,
        ...
        {
          sel: "voyager2", ride: null, mag: 1, spot: null, orbits: TOUR_PLANET_ORBITS,
      ...
      steps: [
        {
          ...
          probeIn: true,
          text: {
            ja: "1997年10月15日、カッシーニは打ち上げられました。打ち上げに使うロケットだけでは、5.7トンの探査機を土星まで直接送れないため、" +
        ...
        },
        {
          ...
          orbits: TOUR_PLANET_ORBITS, d: "1998-04-26T13:20", spd: 25, play: true, until: "1999-08-18T02:00",
          text: {
        ...
        {
          sel: null, ride: null, fit: 6.6, a: 0.55, y: 0.9, mag: 1, orbits: TOUR_PLANET_ORBITS, path: true,
        ...
        {
          sel: null, ride: null, fit: 12, a: 0.55, y: 0.9, mag: 1, orbits: TOUR_PLANET_ORBITS, path: true,
        ...
        },
        {
          ...
          text: {
            ...
            en: "Out of fuel and out of control, it might one day have fallen onto Enceladus. To keep " +
                "that ocean clean, it was aimed at Saturn instead. On 15 September 2017 it entered " +
                "the atmosphere at 34 km/s, transmitting until it burned away.",
          },
        },
        {
          sel: null, ride: null, fit: 12, a: 0.85, y: 1.2, play: false, spot: null, mag: 1,
          d: "2017-09-15", path: true, orbits: TOUR_PLANET_ORBITS,
          text: {
            ja: "たどってきた道のりです。太陽の方へ3回落ちてから外へ — " +
                "一見遠回りに見えますが、これこそがカッシーニが土星までたどり着ける唯一の道でした。" +
                "ボイジャーは通過点だったこの惑星に、カッシーニは13年住みつき、" +
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          text: {
            ja: "流星群が毎年ほぼ同じ時期に現れるのは、軌道に沿って広がった塵の帯を、地球が毎年同じ場所で横切るからです。" +
                "その中には塵が濃く集まった細い帯も残っていて、そこを通る年には多くの流星が流れます。" +
                "同じ季節に見上げる空でも、流星の数は年によって違うのです。",
            en: "Meteor showers return at roughly the same time each year because Earth crosses the dust " +
                "spread along the orbit at the same place. Narrow, denser trails remain within it, " +
                "bringing more meteors in the years when Earth passes through them. " +
                "Even in the same season, the sky offers a different number of meteors each year.",
          },
        },
      ],
    },
    {
      ...
      lead: {
        ...
        en: "What happens when Sun, Earth and Moon line up. Watch each eclipse run from first contact to last, from the side that falls into the shadow and from the side that casts it.",
      },
      steps: [
        {
          view: "ground", site: [35.68, 139.69], d: "2025-09-07T16:25", sel: "moon",
          aim: true, gfov: 1.4, mag: 1, constel: false, mark: false, sky: true,
          spd: 0.0025, play: true, until: "2025-09-07T17:36",
          text: {
            ja: "2025年9月8日の未明、東京。満月が地球の影へ入っていくところを、" +
                "1秒に3分半ほどの早回しで追います。" +
                "欠けぎわがぼやけているのは、太陽が点ではなく広がりを持った円盤だから。" +
                "月から見ると、地球の縁が太陽面を少しずつ隠していきます。",
            en: "Tokyo, the small hours of 8 September 2025. Watch the full Moon slide into Earth's shadow, " +
                "running at about three and a half minutes per second. " +
                "The bitten edge looks soft because the Sun is not a point but a disc: " +
                "seen from the Moon, Earth's limb covers it gradually rather than all at once.",
          },
        },
        {
          d: "2025-09-07T17:36", spd: 0.0042, until: "2025-09-07T19:45",
          text: {
            ja: "皆既。ここから1時間20分、月面のどこに立っても太陽は地球にすっかり隠されています。" +
                "それでも真っ暗にならず赤銅色に光るのは、地球の大気を回り込んだ光が届いているから。" +
                "青い光は散乱で失われ、残った赤だけが影の中を満たします。" +
                "そのまま影の外へ出るところまで。",
            en: "Totality. For the next eighty minutes, anywhere you stand on that surface, " +
                "Earth completely hides the Sun. It still is not black but copper red, because sunlight " +
                "bent through Earth's atmosphere reaches in: the blue is scattered away and only the red " +
                "gets through to fill the shadow. The run carries on until the Moon leaves the shadow.",
          },
        },
        {
          view: "space", sel: "moon", km: 11000, lit: true, orbits: false, cut: true,
          d: "2025-09-07T18:45", spd: 0.0008, until: "2025-09-07T19:05",
          text: {
            ja: "同じ「影を出る瞬間」を宇宙から。1秒に1分ほどまで落としてあります。" +
                "縁のひとところに直射日光が戻ると、そこだけ桁違いに明るくなり、" +
                "赤銅色の残りは目では追えなくなります — 皆既のあいだだけ赤い月が見えるのは、" +
                "比べる相手が無いからでもあります。",
            en: "The same exit, now from space, slowed to about a minute per second. " +
                "The instant direct sunlight returns to one edge, that sliver becomes orders of magnitude " +
                "brighter than the rest, and the copper glow is lost to the eye. " +
                "Part of why the red Moon is only visible during totality is that nothing outshines it.",
          },
        },
        {
          sel: "earth", fit: 0.0034, a: 0, apart: "sun", sight: "sun", mark: true,
          d: "2025-09-07T18:13", play: false,
          text: {
        ...
        {
          spd: 5, play: true, until: "2025-12-08",
          text: {
            ja: "このまま3か月ぶん流します。月が地球を回るたびに、破線の上を通ることもあれば、" +
                "上や下へ外れて通り過ぎることもあります。月の軌道が地球の軌道面から 5° 傾いているからで、" +
                "満月・新月のたびに影を通るわけではありません。" +
                "食が起きるのはその瞬間が「2つの軌道面が交わる線」の近くに来たときだけ — " +
                "月食も日食も年に数回しかないのはこのためです。" +
                "(破線がゆっくり回るのは、地球自身も公転しているからです)",
            en: "Now let three months run. Each time the Moon goes round, it sometimes crosses the dashed line " +
                "and sometimes passes above or below it. Its orbit is tilted about 5° to Earth's, so full and " +
                "new moon do not land in the shadow every month. An eclipse needs that moment to fall near the " +
                "line where the two orbital planes cross, which is why we only get a few each year. " +
                "(The dashed line slowly swings because Earth is going round the Sun as well.)",
          },
        },
        {
          view: "ground", site: [35.68, 139.69], d: "2035-09-02T00:20", sel: "sun",
          aim: true, gfov: 1.4, sight: null, apart: null, mark: false, sky: true,
          spd: 0.0022, until: "2035-09-02T01:12",
          text: {
            ja: "同じ並びを、月が内側 — 新月の側へ来たときに作ると日食になります。" +
                "2035年9月2日の朝、東京。月が太陽の前を横切りはじめてから、隠しきるまでの1時間弱を早回しで。" +
            ...
            en: "Make the same alignment with the Moon on the inside — at new moon — and you get a solar eclipse. " +
                "Tokyo, the morning of 2 September 2035: the hour from first contact to the Moon covering the Sun entirely. " +
        ...
        {
          d: "2035-09-02T01:11", spd: 0.00019, until: "2035-09-02T01:15",
          text: {
            ja: "皆既の前後4分を、1秒に15秒ほどまで落としました。" +
                "最後のひとかけらが消えると、まわりに真珠色のコロナが現れます。" +
                "普段は光球が明るすぎて見えないだけで、コロナはいつでもそこにあります。" +
                "東京で見られる皆既はわずか2分 — また縁から光がこぼれれば終わりです。",
            en: "The four minutes around totality, slowed to about fifteen seconds per second. " +
                "As the last sliver goes, the pearl-white corona appears around the disc. " +
                "It is always there; the photosphere is simply too bright to let us see it. " +
                "Totality in Tokyo lasts barely two minutes — the moment light spills back over the edge, it is over.",
          },
        },
        {
          gfov: 85, d: "2035-09-02T01:08", spd: 0.0005, until: "2035-09-02T01:19",
          text: {
            ja: "同じ数分を、今度は空全体で。朝の空が暗くなって星と惑星が現れ、また明るくなります。" +
                "本影が地表に落とす帯は幅 100km ほどしかなく、そこを通り過ぎるのに数分。" +
                "その数分のあいだだけ、帯の上にいる人が昼の空に星を見ることになります。",
            en: "The same few minutes, now across the whole sky. The morning darkens, the stars and planets " +
                "come out, and then it brightens again. The umbra paints a band only about a hundred kilometres " +
                "wide across the ground and sweeps past in minutes. " +
                "For those minutes, anyone standing in that band sees stars in a daytime sky.",
          },
        },
        {
          site: [43.06, 141.35], d: "2030-06-01T07:50", gfov: 1.4,
          spd: 0.00065, until: "2030-06-01T08:07",
          text: {
        ...
        {
          view: "moon", d: "2025-09-07T17:30", sel: "earth", aim: true, gfov: 4.2, mark: false,
      ...
      steps: [
        {
          ...
          text: {
            ja: "2026年12月、東京。しし座が南中する向きに空を固定して、これから同じ星空を5回見ます。" +
                "火星はしし座の1等星レグルスの東 (左) にいて、日ごとに東へ進んでいるところです。" +
        ...
        {
          d: "2027-01-10T17:29",
          trail: { key: "mars", dates: ["2026-12-05T19:50", "2027-01-10T17:29"], labels: ["12/6", "1/11"] },
          text: {
            ja: "1月10日。火星はさらに東へ進みました。ここが折り返し (留) で、" +
        ...
        {
          d: "2027-02-19T14:51",
          trail: { key: "mars", dates: ["2026-12-05T19:50", "2027-01-10T17:29", "2027-02-19T14:51"], labels: ["12/6", "1/11", "2/19"] },
          text: {
            ja: "2月19日は衝です。太陽の反対側に来て一晩じゅう見え、いちばん大きく明るい日です。" +
                "12月からの動きを見比べると、火星は西 (右) へ戻ってきています。これが逆行です。",
        ...
        {
          d: "2027-04-01T12:10",
          trail: { key: "mars", dates: ["2026-12-05T19:50", "2027-01-10T17:29", "2027-02-19T14:51", "2027-04-01T12:10"], labels: ["12/6", "1/11", "2/19", "4/1"] },
          text: {
            ja: "4月1日。西へ戻りきって、また折り返します (2度目の留)。" +
        ...
        {
          d: "2027-05-15T09:17",
          trail: { key: "mars", dates: ["2026-12-05T19:50", "2027-01-10T17:29", "2027-02-19T14:51", "2027-04-01T12:10", "2027-05-15T09:17"], labels: ["12/6", "1/11", "2/19", "4/1", "5/15"] },
          text: {
            ja: "5月15日。火星はまた東へ進んでいます。5回の位置を矢印でつなぐと、火星は空にひとつの輪 (ループ) を描きました。" +
                "古代の天文学者を最も悩ませた動きで、天動説はこれを説明するために、円の上をさらに小さな円が回る" +
                "「周転円」を必要としました。",
            en: "15 May. Mars is heading east once more. Join the five positions with arrows and it has drawn a loop " +
        ...
        },
        {
          ...
          radiant: null, trail: null, d: "2026-12-05", spd: 5, play: true, until: "2027-05-15",
          text: {
            ja: "同じ半年を、太陽系の上から。内側の地球は687日で一周する火星より速く回るので、" +
                "2月に内側から火星を追い越します。追い越すあいだ、地球から見た火星の方向は後ろへ動きます。" +
        ...
        },
        {
          ...
          text: {
            ja: "地球を画面の中央に固定すると、破線 (地球から火星への視線) の振れ方がそのまま空での動きになります。" +
                "普段は一方向へ回っていく破線が、追い越しの前後だけ逆へ振れます。" +
      ...
      steps: [
        {
          ...
          text: {
            ja: "木星から260万kmの位置から、1秒に2時間ほどの早回しで2日ぶんを見ます。内側から イオ (1.8日で一周)・" +
                "エウロパ (3.6日)・ガニメデ (7.2日)・カリスト (16.7日) です。" +
        ...
        },
        {
          sel: "europa", km: 7000,
          text: {
            ja: "エウロパは氷の殻に覆われ、ひび割れの筋が縦横に走っています。" +
        ...
        },
        {
          ...
          text: {
            ja: "ガニメデは太陽系最大の衛星で、直径 5,268 km は惑星の水星より大きいほどです。" +
        ...
        },
        {
          ...
          text: {
            ja: "カリストは4つのうち最も外側で、太陽系でいちばんクレーターの多い天体のひとつです。" +
        ...
        },
        {
          ...
          text: {
            ja: "木星面を渡るイオの影を、1秒に9分ほどの早回しで見ます。衛星が木星と太陽のあいだを通るたびに、" +
    ...
    // ---- 大彗星の時代 (百武・ヘール＝ボップ・ネオワイズ・紫金山＝アトラス) ----
    {
      ...
      lead: {
        ja: "1996年と97年に続けて現れた2つの大彗星 — 地球のすぐそばを通った百武と、巨大な核で1年半見え続けたヘール＝ボップです。" +
            "その後の2020年・2024年の彗星まで、見えた日の空を訪ねます。",
      ...
      steps: [
        {
          ...
          text: {
            ja: "1996年3月25日の未明、東京。百武彗星が地球から 0.10 au (1,500万km) を通り過ぎる夜です。" +
                ...
                "これほど近くを通る明るい彗星は数百年に一度です。発見からわずか2か月後のことでした。",
        ...
        },
        {
          ...
          text: {
            ja: "宇宙から見ます。彗星は地球のほぼ真上 (黄道の北側) を、太陽へ向かって落ちていきます。" +
                "地球のそばを通ったのは近日点の1か月前でした。近さのおかげで、核が直径 4 km ほどの小さな彗星が" +
                "大彗星になりました。",
        ...
        },
        {
          ...
          text: {
            ja: "翌1997年3月30日の夕方、東京。北西の空にヘール＝ボップ彗星が見えています。" +
                "地球からは 1.3 au と遠かったのに、直径 60 km の巨大な核が大量のガスと塵を出し、" +
                "都会の空でも肉眼で見えました。肉眼で見え続けた期間は18か月で、史上最長です。",
        ...
        },
        {
          ...
          text: {
            ja: "軌道面は黄道からほぼ垂直 (89°) です。上から降りてきて、近日点 (4月1日、0.9 au) を回って上へ戻っていきます。" +
                "一周に約2,400年かかり、前回は紀元前2200年ごろ、次は西暦4400年ごろです。",
        ...
        },
        {
          ...
          text: {
            ja: "2020年7月14日の明け方、東京。北東の低い空にネオワイズ彗星が見えています。" +
                "ヘール＝ボップ以来23年ぶりに肉眼で楽に見えた彗星で、" +
                "この後は夕方の北西の空へ移って7月いっぱい楽しめました。次に戻るのは約6,800年後です。",
        ...
        },
        {
          ...
          text: {
            ja: "2024年10月13日の夕方 18時すぎ、東京。西の低い空に紫金山・アトラス彗星が見えています。" +
                "この彗星の軌道は双曲線で、太陽系を離れたら二度と戻りません。" +
                "大彗星は何十年かに一度しか来ませんが、いつ来るかは誰にも分かりません。次の1つは、もう太陽へ向かっているかもしれません。",
