  ...
  function buildHowto() {
    const c = lang === "ja" ? {
      ...
      common_rows: [
        ...
        ["星座", "メニュー「星座」(星座線・星座名・明るい星の名前。黄道も連動)"],
        ["経緯線", "メニュー「経緯線」(天球の赤経・赤緯)"],
        ["星雲・星団", "メニュー「星雲・星団」(メシエ天体)"],
        ["空と地形", "メニュー「空と地形」(昼の空の明るさ・地平の稜線・地面の質感。切ると昼でも星空のまま)"],
      ...
      common_rows: [
        ...
        ["Constellations", "Menu → “Constellations” (lines, names and bright-star names; the ecliptic follows)"],
        ["Coordinate grid", "Menu “Coordinate grid” (RA & Dec on the sky)"],
        ["Deep-sky", "Menu “Deep-sky objects” (Messier catalog)"],
        ["Sky & terrain", "Menu “Sky & terrain” (daylight sky, ridgeline, ground texture; off keeps a starry sky even by day)"],
  ...
  function buildWelcome() {
    ...
    welcomeEl.innerHTML =
      `<div id="welcomeCard">` +
        `<h2 class="logo"><span id="welcomeLogo">SIDEREUM</span><span class="yomi">${c.yomi}</span></h2>` +
